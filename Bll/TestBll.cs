...
namespace Bll
{
    public class TestBll
    {
       ...
       UserDal _userDal=new UserDal();
        ...
        /// <returns></returns>
        public ReturnModel GetUserInfoByUserName(string userName)
        {

            ReturnModel userinfo = null;
            try
            {
                string url = PubConstant.WineGameWebApi + "api/userinfo/GetUserEp";

                var result = HttpClientHelper.PostResponse<ReturnModel>(url, new { username = userName });
            ...
            catch (Exception ex)
            {
                ...
                LogHelper.WriteLog(typeof(TestBll), "GetUserInfoByUserName", Engineer.ggg, new { userName = userName }, ex);
            }
        ...
        //                    continue;
        //                }
        //                accInfo.WaitRelease += dayStaticsEp * ratio;
