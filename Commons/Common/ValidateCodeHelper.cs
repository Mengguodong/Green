...
namespace Common
{
    ...
    public class ValidateCodeHelper
    {
        ...
        {
            int randAngle = 25; //随机转动角度
            int mapwidth = (int)(randomcode.Length * 30);
            Bitmap map = new Bitmap(mapwidth, 45);//创建图片背景
            ...
            for (int i = 0; i < chars.Length; i++)
            {
                ...
                Font f = new System.Drawing.Font(font[findex], 36, System.Drawing.FontStyle.Bold);//字体样式(参数2为字体大小)
